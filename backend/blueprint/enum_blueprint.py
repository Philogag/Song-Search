...
from backend.utility.enum_helper import enum_to_dict, enum_to_selection, enum_to_tuple
...
def route_get_enum_tuple(result_type, enum_name):
    ...
    return result_type_transform[result_type](
        get_enum_class_by_underline_name(enum_name)
    )
