...
class DataPermissionDetailRepository(BasicRepository):
    @classmethod
    def get_details_by_data_permission_id(
        cls, data_permission_id
    ) -> List[DataPermissionDetailEm]:
    ...
    @classmethod
    def insert_detail(
        cls, data: DataPermissionDetailEm, transaction: Transaction
    ) -> str:
