<template>
  <Dropdown placement="bottomLeft" :overlayClassName="`${prefixCls}-dropdown-overlay`" :trigger="['click']">
    ...
    <template #overlay>
      <Menu @click="handleMenuClick">
        <div v-if="getUserRoles">
          <MenuItem
            v-for="item in getUserInfo.roles" :key="'role-' + item.id"
            :text="item.roleName"
  ...
  export default defineComponent({
    ...
    setup() {
      ...
      const getUserInfo = computed(() => {
        const { username: realName, avatar, desc, roles, currentRole } = userStore.getUserInfo || {};
